  ...
  return (
    <main>
      <header className="page-header" style={{ padding: '180px 20px 80px', textAlign: 'center', background: 'var(--clr-darker)' }}>
        ...
        <h1 className="hero-title" style={{ fontSize: '3rem', marginBottom: '10px' }}>Live Zoning Analytics</h1>
        <p className="hero-subtitle" style={{ margin: '0 auto', color: 'var(--clr-gold)' }}>See the future of your neighborhood before you buy.</p>
      </header>
