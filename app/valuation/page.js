  ...
  return (
    <main>
      <header className="page-header" style={{ padding: '180px 20px 80px', textAlign: 'center', background: 'var(--clr-darker)' }}>
        ...
        <h1 className="hero-title" style={{ fontSize: '3rem', marginBottom: '10px' }}>Get Home Valuation</h1>
        <p className="hero-subtitle" style={{ margin: '0 auto', color: 'var(--clr-gold)' }}>Discover your home's hidden equity.</p>
      </header>
